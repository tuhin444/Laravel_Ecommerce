...
@section('content')
      ...
      <div class="content">
            ...
            <div class="col-lg-12 col-md-12">
              ...
              <div class="card">
                ...
                <div class="card-header card-header-warning">
                  <h4 class="card-title" style="text-align:center;">Update District</h4>
       ...
       <form action="{{ route('admin.district.update',$districts->id) }}" method="post" >
                @csrf
            ...
            <div class="form-group">
              ...
              @foreach($divistions as $div)
                 <option value="{{$div->id}}"<?php if($div->id==$districts->divistion_id ) echo"selected";?>>{{$div->name}}</option>
              @endforeach
