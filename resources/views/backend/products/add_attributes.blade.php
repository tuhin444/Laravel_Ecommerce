       ...
       <div class="row">
          ...
          <div class="col-sm-12">
             <div class="panel panel-bd lobidrag">
                ...
                <form class="col-sm-6" enctype="multipart/form-data" action="{{url('/admin/add-attributes/'.$productDetails->id)}}" method="post"> 
                 @csrf
                    ...
                    @csrf
                        ...
                        <tbody>
                           ...
                           <td style="display:none;"><input type="hidden" name="attr[]" value="{{$attribute->id}}">{{$attribute->id}}</td>
                             ...
                             <td><input type="text" name="sku[]" value="{{$attribute->sku}}" style="text-align:center;    width: 78%;"> </td>
                              <td><input type="text" name="size[]" value="{{$attribute->size}}" style="text-align:center;    width: 78%;"> </td>
                              <td><input type="text" name="price[]" value="{{$attribute->price}}" style="text-align:center;     width: 78%;"> </td>
                              <td><input type="text" name="stock[]" value="{{$attribute->stock}}" style="text-align:center;width: 78%;"> </td>
                              <td class="center">
                                 <div class="btn-group">
